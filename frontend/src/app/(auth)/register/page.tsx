...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-[#F6F2EA] relative overflow-hidden text-[#151515] font-sans selection:bg-[#4CB8C4]/20">
      ...
      {/* Form Side */}
      <div className="flex items-center justify-center p-8 order-2 lg:order-1 relative z-10">
        <motion.div 
        ...
        >
          <div className="mb-10 text-center sm:text-left">
            <h1 className="text-[32px] font-bold tracking-tight text-[#151515] mb-2">Start Protocol</h1>
          ...
          <p className="text-center text-[14px] text-[#151515]/60 mt-8">
            ...
            <Link href="/login" className="font-semibold text-[#4CB8C4] hover:text-[#4CB8C4]/80 transition-colors hover:underline underline-offset-4">
              Sign in
            </Link>
          </p>
        </motion.div>
      ...
      {/* Visual Side */}
      <div className="hidden lg:flex flex-col justify-center items-center relative overflow-hidden bg-[#4CB8C4]/[0.03] border-l border-[#D8D2C7]/30 order-1 lg:order-2 z-10">
        <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] rounded-full bg-[#4CB8C4]/10 blur-[120px] mix-blend-multiply" />
        <div className="absolute bottom-1/4 left-1/4 w-[500px] h-[500px] rounded-full bg-[#F56C86]/5 blur-[120px] mix-blend-multiply" />
        ...
        <div className="relative z-10 max-w-[440px] text-center p-12 bg-white/50 backdrop-blur-xl rounded-[32px] border border-white shadow-[0_8px_40px_rgba(0,0,0,0.02)]">
          <Activity className="w-12 h-12 text-[#4CB8C4] mx-auto mb-8 animate-float" strokeWidth={1.5} />
          <h2 className="text-[32px] font-bold mb-4 tracking-tight text-[#151515] leading-tight">Rewire Your Baseline</h2>
