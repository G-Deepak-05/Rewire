.PHONY: help dev build down logs migrate migrate-create test test-cov lint format typecheck clean
...
help: ## Show this help message
	@echo "Rewire — Developer Commands"
	@echo "============================"
...
db-shell: ## Open psql shell
	$(COMPOSE) exec postgres psql -U rewire -d rewire
